...
func registerForEvent(context *gin.Context) {
	...
	context.JSON(http.StatusCreated, gin.H{"message": "Register confirmed"})
}
...
func cancelResgistration(context *gin.Context) {
	...
	err = event.CancelResgistration(userId)
	...
	context.JSON(http.StatusCreated, gin.H{"message": "Cancellation confirmed"})
}
